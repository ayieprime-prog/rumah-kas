...
import { Wallet, TrendingUp, DollarSign, Target, CreditCard, BarChart3, ChevronRight } from 'lucide-react'
import './ListPages.css'

const items = [
  { path: '/expenses', label: 'Pengeluaran', desc: 'Catat & lihat pengeluaran bulanan', icon: Wallet, sw: 'sw-1' },
